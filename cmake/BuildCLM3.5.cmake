...
if(${ParFlow})
  list(APPEND CLM35_CONFIG_OPTS -fflags -I${OASIS_INSTALL_PREFIX}/include)
else()
  list(APPEND CLM35_CONFIG_OPTS -fflags -I${OASIS_ROOT}/include)
endif()
...
list(APPEND TSMP2_MODEL_VERSIONS "CLM3.5: ${CLM35_VERSION}")
