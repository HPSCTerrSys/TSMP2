...
elseif(CMAKE_Fortran_COMPILER_ID STREQUAL "Intel" OR CMAKE_Fortran_COMPILER_ID STREQUAL "IntelLLVM")
  set(ICON_CFLAGS "-fp-model=strict -Wall")
  set(ICON_FCFLAGS "-warn all -check all -standard-semantics -fpmodel=precise -qno-openmp-simd")
endif()
...
elseif (CMAKE_BUILD_TYPE STREQUAL "RELEASE")
  string(PREPEND ICON_CFLAGS "-O0 ")
  string(PREPEND ICON_FCFLAGS "-O0 ")
else()
