...
if(${CLM3.5})
  ...
  file(APPEND ${OASIS_MAKE_INC} "###############################################################################\n")
  file(APPEND ${OASIS_MAKE_INC} "#\n")
  file(APPEND ${OASIS_MAKE_INC} "# CHAN : MPI1/MPI2\n")

  file(APPEND ${OASIS_MAKE_INC} "CHAN            = MPI1\n")

  file(APPEND ${OASIS_MAKE_INC} "#\n")
  file(APPEND ${OASIS_MAKE_INC} "# Paths for libraries, object files and binaries\n")
  file(APPEND ${OASIS_MAKE_INC} "#\n")
  file(APPEND ${OASIS_MAKE_INC} "# COUPLE        : path for the root of prism directory tree, can be anywhere\n")
  file(APPEND ${OASIS_MAKE_INC} "# ARCHDIR       : directory created when compiling\n")
  file(APPEND ${OASIS_MAKE_INC} "# LIBPSMILE     : list of oasis3 libraries\n")
  file(APPEND ${OASIS_MAKE_INC} "# PSMILE_INCDIR : includes all *o and *mod for each library\n")
  file(APPEND ${OASIS_MAKE_INC} "# BINDIR        : directory for executables\n")
  file(APPEND ${OASIS_MAKE_INC} "# LIBBUILD      : contains a directory for each library\n")
  file(APPEND ${OASIS_MAKE_INC} "#\n")
  ...
  file(APPEND  ${OASIS_MAKE_INC} "PSMILE_INCDIR   = -I$(LIBBUILD)/psmile.$(CHAN) -I$(LIBBUILD)/scrip  -I$(LIBBUILD)/mct ${NetCDF_ROOT}/include\n")
  file(APPEND  ${OASIS_MAKE_INC} "BINDIR          = $(ARCHDIR)/bin\n")
  file(APPEND  ${OASIS_MAKE_INC} "LIBBUILD        = $(ARCHDIR)/build/lib\n")

  file(APPEND ${OASIS_MAKE_INC} "#\n")
  file(APPEND ${OASIS_MAKE_INC} "# MPI library\n")
  file(APPEND ${OASIS_MAKE_INC} "#\n")
  file(APPEND ${OASIS_MAKE_INC} "# NETCDF library\n")
  file(APPEND ${OASIS_MAKE_INC} "#\n")
  file(APPEND ${OASIS_MAKE_INC} "# Compiling and other commands\n")
  ...
  file(APPEND ${OASIS_MAKE_INC} "#\n")
  file(APPEND ${OASIS_MAKE_INC} "# compiler options and cpp keys\n")
  file(APPEND ${OASIS_MAKE_INC} "# \n")

  if(${PDAF})
    file(APPEND  ${OASIS_MAKE_INC} "CPPDEF          = -Duse_libMPI -Duse_netCDF -Duse_comm_$(CHAN) -DVERBOSE -DDEBUG  -DTREAT_OVERLAY -DUSE_PDAF\n")
  else()
    file(APPEND  ${OASIS_MAKE_INC} "CPPDEF          = -Duse_libMPI -Duse_netCDF -Duse_comm_$(CHAN) -DVERBOSE -DDEBUG  -DTREAT_OVERLAY\n")
  endif()

  file(APPEND ${OASIS_MAKE_INC} "#\n")
  file(APPEND ${OASIS_MAKE_INC} "# For compiling in double precision, put -r8\n")
  file(APPEND ${OASIS_MAKE_INC} "# For compiling in single precision, remove -r8 and add -Duse_realtype_single\n")
  file(APPEND ${OASIS_MAKE_INC} "# \n")

  file(APPEND  ${OASIS_MAKE_INC} "F90FLAGS        = -C -i4 -r8 $(PSMILE_INCDIR) $(CPPDEF)\n")
  file(APPEND  ${OASIS_MAKE_INC} "f90FLAGS        = $(F90FLAGS)\n")
  file(APPEND  ${OASIS_MAKE_INC} "FFLAGS          = $(F90FLAGS)\n")
  file(APPEND  ${OASIS_MAKE_INC} "fFLAGS          = $(F90FLAGS)\n")
  file(APPEND  ${OASIS_MAKE_INC} "CFLAGS          = $(PSMILE_INCDIR) $(CPPDEF)\n")
  file(APPEND  ${OASIS_MAKE_INC} "CCFLAGS         = $(PSMILE_INCDIR) $(CPPDEF)\n")
  file(APPEND  ${OASIS_MAKE_INC} "LDFLAGS         = \n")
