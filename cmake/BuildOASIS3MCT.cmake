...
file(APPEND  ${OASIS_MAKE_INC} "NETCDF_LIBRARY  = -L${NETCDF_LIB_DIR} -lnetcdff -lnetcdf\n")
...
file(APPEND  ${OASIS_MAKE_INC} "LD              = mpifort -L${MPI_Fortran_LIB_DIR}\n")
...
file(APPEND  ${OASIS_MAKE_INC} "FLIBS           = $(NETCDF_LIBRARY)\n")
