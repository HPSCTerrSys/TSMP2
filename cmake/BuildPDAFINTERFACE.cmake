...
list(APPEND PDAFINTERFACE_ENV_VARS TSMPPDAFIMPORTFLAGS=${PDAF_INCLUDES})
list(APPEND PDAFINTERFACE_ENV_VARS TSMPPDAFCPPDEFS=${PDAF_DEFS})
list(APPEND PDAFINTERFACE_ENV_VARS TSMPPDAFLIBS=${PDAF_LIBS})
...
if(DEFINED eCLM_SRC)
  list(APPEND PDAFINTERFACE_ENV_VARS eCLM_SRC="${eCLM_SRC}")
endif()
if(DEFINED CLM35_SRC)
  list(APPEND PDAFINTERFACE_ENV_VARS CLM35_SRC="${CLM35_SRC}")
endif()
if(DEFINED ICON_SRC)
  list(APPEND PDAFINTERFACE_ENV_VARS ICON_SRC="${ICON_SRC}")
endif()
if(DEFINED COSMO_SRC)
  list(APPEND PDAFINTERFACE_ENV_VARS COSMO_SRC="${COSMO_SRC}")
endif()
if(DEFINED PARFLOW_SRC)
  list(APPEND PDAFINTERFACE_ENV_VARS PARFLOW_SRC="${PARFLOW_SRC}")
endif()
